    ...
    <header id="header">
        <section>
            ...
            <?php if (isset($header_blocks["block-1"]) && $header_blocks["block-1"] == "logo"): ?>
                ...
                <div class="dm-logo">
                    <a href="<?php echo $jsonGlobalData["front-page"]["slug"] . $jsonGlobalData["page-slug-extension"]; ?>"
                        class="dm-logo-img">
            ...
            <?php if (isset($header_blocks["block-2"]) && $header_blocks["block-2"] == "menu"): ?>
                ...
                <div class="dm-menu">
                    ...
                    <div class="dm-menu-utility">
                        <a href="<?php echo $jsonGlobalData["search-page"]["slug"] . $jsonGlobalData["page-slug-extension"]; ?>"
                            class="dm-search">
