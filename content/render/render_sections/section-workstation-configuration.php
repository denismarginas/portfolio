...
$products = $jsonWorkstationData["setups"]["setup 1"]["configuration"];
?>

<section class="dm-workstation-configuration dm-workstation-products grid-background-animation"
        <?php if( !empty($layout) ) : ?>
    ...
    <container>
        <ul>
            <li data-motion="transition-fade-0 transition-slideInRight-0">
                <?php
                $img = $jsonWorkstationData["setups"]["setup 1"]["images"]["workstation"][1];
            ...
            <li data-motion="transition-fade-0 transition-slideInLeft-0">
                <h2><?php echo $jsonWorkstationData["setups"]["setup 1"]["title"]; ?> Configuration</h2>
                <ul>
                ...
                <div class="product" id="<?php echo $key; ?>" data-motion="transition-fade-0 transition-slideInRight-0">
                    <div class="product-image">
                        ...
                        if( isset($product["img-src-box"]) ) :
                            echo renderImage($GLOBALS['urlPath']."content/img/".$path."/".$product["img-src-box"]);
                        endif; ?>
