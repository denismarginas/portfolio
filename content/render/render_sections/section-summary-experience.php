    ...
    <div class="dm-experience-section" data-motion="transition-fade-0" data-duration="1s">
        ...
        <ul grid="3">
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/casadarius-shop/videos_1/casadarius_3.mp4",$GLOBALS['urlPath']."content/img/projects/casadarius-presentation/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/agromir/videos_1/agromir_7.webm",$GLOBALS['urlPath']."content/img/projects/agromir/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
        ...
        <ul grid="3">
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/busvip/videos_3/busvip_2.mp4",$GLOBALS['urlPath']."content/img/projects/busvip/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
        ...
        <ul grid="3">
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/busvip/videos_2/busvip_3.mp4",$GLOBALS['urlPath']."content/img/projects/busvip/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                 </li>
                <li>
        ...
        <ul grid="3">
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/dsautocenter/dsautocenter_1.mp4",$GLOBALS['urlPath']."content/img/projects/dsautocenter/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/revelnail-avadores/videos_2/avadores_4.mp4",$GLOBALS['urlPath']."content/img/projects/revelnail-avadores/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/agromir/videos_3/agromir_4.webm",$GLOBALS['urlPath']."content/img/projects/agromir/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
        </ul>
        <ul grid="3">
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/strikerproduction/csgo/NoMercy_CSGO.webm",$GLOBALS['urlPath']."content/img/projects/strikerproduction/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/strikerproduction/pubg/SleeplessNight_PUBG.webm",$GLOBALS['urlPath']."content/img/projects/strikerproduction/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/strikerproduction/rust/CoverYourEyes_Rust.webm",$GLOBALS['urlPath']."content/img/projects/strikerproduction/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
        </ul>
        </container>
    </div>
    ...
    <div class="dm-experience-section" data-motion="transition-fade-0" data-duration="1s">
        ...
        <ul grid="2/1">
                ...
                <li>
                    <?php echo renderVideo($GLOBALS['urlPath']."content/vid/projects/agromir/videos_2/agromir_5.webm",$GLOBALS['urlPath']."content/img/projects/agromir/logo/logo.png", $GLOBALS['urlPath']."content/img/thumbnails/workpreview-summary-thumbnail.webp"); ?>
                </li>
            </ul>
            <ul grid="3">
                <li>
