...
$post_data = [
    ...
    "colors" => [
        "post_color_primary" => "#462124",
        "post_color_secondary" => "#FFFFFF",
        "post_color_background" => "#462124",
