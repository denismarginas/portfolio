<section class="dm-web-development-experience grid-background-animation">
    <container>
        <ul>
            ...
            <li>
                <img width="320px" height="260" src="<?php echo $GLOBALS['urlPath']; ?>content/img/design-elements/portfolio-experience-image.png" alt="Web Development Experience" data-motion="transition-fade-0 transition-slideInLeft-0" data-duration="1s" data-delay="0.1s">
            </li>
        </ul>
    </container>
</section>